...
public class Blocker extends LimitedSubsystem {
	...
	public Blocker(SpeedController motor, DigitalInput stopBreaking) {
		super(motor);
		this.stopBreaking = stopBreaking;
	}

	public Blocker(int motorPort, int digitalInputPort) {
